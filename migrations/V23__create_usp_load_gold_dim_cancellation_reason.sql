...
-- Description: Creates the stored procedure that loads gold.dim_cancellation_reason
--              with seed data. Four cancellation codes: A, B, C, D.
...
BEGIN
  ...
  INSERT INTO gold.dim_cancellation_reason(cancellation_code, code_description, created_at, updated_at)
  VALUES
      ('A', 'Carrier',                   NOW(), NULL),
      ('B', 'Weather',                   NOW(), NULL),
