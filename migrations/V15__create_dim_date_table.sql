...
-- Description: Creates the dim_date table in the gold schema.
--              This is a calendar dimension generated programmatically
--              covering all dates in 2015. Used as the time dimension
--              in the star schema for flight delay analysis.
...
'Time dimension in the start schema for flight delay analysis.';

COMMENT ON COLUMN gold.dim_date.date_id IS
'Date in YYYYMMDD format (e.g.20150115).';
