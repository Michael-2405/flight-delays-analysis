...
-- Description: Creates gold.dim_airport — airport dimension for
--              the star schema. Role-playing dimension used as
--              both origin and destination in fct_flights.
--              Loaded from silver.airport_clean via UPSERT (SCD1).
...
'Geographic latitude coordinate. NULL for ECP, PBG, UST.';
COMMENT ON COLUMN gold.dim_airport.longitude IS
'Geographic longitude coordinate. NULL for ECP, PBG, UST.';
